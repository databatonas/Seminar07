...
/* Если пользователь ввёл количество строк или столбцов, равным нулю, то выведем на экран 
"Матрица не существует" и вернёмся к началу операции.*/
if(rows == 0 && columns == 0) return; Console.WriteLine("Матрица не существует.");                 
...
{
    Console.WriteLine("Некорректный ввод данных. Введите целое положительное число.");
}