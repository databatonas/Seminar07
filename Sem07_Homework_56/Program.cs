...
try /* Блок обработки исключений.*/
{
    ...
    /* Метод, который будет находить строку с наименьшей суммой элементов.*/
    ...
    MinRowsSum(matrix, arr); /* Вызов метода, который будет находить строку с наименьшей суммой элементов.*/
